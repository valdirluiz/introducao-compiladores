...
e1 = new FloatConstNode(t2);
          ...
          case null_constant:{
            t2 = jj_consume_token(null_constant);
e1 = new NullConstNode(t2);
            break;
            }
          default:
            jj_la1[22] = jj_gen;
...
{if ("" != null) return new ReturnNode(t1, e1);}
      } catch (ParseException e) {
...
if(l==null) l = new ListNode(new NullConstNode(t)); else l.add(new NullConstNode(t));
          break;
          }
        case int_constant:
        case boolean_constant:
  ...
  private boolean jj_3R_21()
 {
  ...
  static {
   ...
   private static void jj_la1_init_1() {
      jj_la1_1 = new int[] {0x0,0x0,0x0,0x0,0x0,0x0,0x400,0x400,0x20000,0x100000,0x20000,0x400,0x20000,0x400,0x20000,0x100000,0x400,0x20000,0x400,0x88403,0xc00025f0,0xc00025f0,0xc00027f0,0xc00027f0,0x0,0x0,0x0,0x400,0xc0002490,0x400,0x88403,0x220000,0x20000,0x200000,0x400,0x20000,0x400,0x3f000000,0x3f000000,0xc0000000,0xc0000000,0x0,0x0,0xc0000000,0xc0000000,0x2490,0xc00027f0,0x100000,0xc00027f0,0xc00027f0,0x0,0x0,0x0,0x0,0xc,0xc,0x88403,};
   }
